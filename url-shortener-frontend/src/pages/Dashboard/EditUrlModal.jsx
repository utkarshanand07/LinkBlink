            ...
            <div className="bg-white dark:bg-slate-900 rounded-[2rem] p-8 w-full max-w-md shadow-premium dark:shadow-glass-dark border border-slate-200 dark:border-slate-700 transform transition-all animate-fade-in">
                ...
                <div className="flex justify-end gap-3 w-full sm:w-auto">
                    ...
                    <button
                        ...
                        className="flex-1 sm:flex-none px-6 py-3.5 text-sm font-semibold text-white dark:text-slate-900 bg-slate-900 dark:bg-white rounded-xl transition-all shadow-md active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100"
                    >
                        Save Changes
                    </button>
                </div>
